<div class="container">
    ...
    <div class="login-box" style="width: 50%; display: block;">
        ...
        <form method="post" action="<?php echo URL; ?>login/register_action">
            ...
            <input type="text" pattern="[a-zA-Z0-9]{2,64}" name="user_name"
                   placeholder="Username (letters/numbers, 2-64 chars)" required validate/>
            <input type="text" name="user_email" placeholder="email address (a real address)" required validate/>
            <input type="password" name="user_password_new" pattern=".{6,}" placeholder="Password (6+ characters)"
                   required autocomplete="off" validate/>
            <input type="password" name="user_password_repeat" pattern=".{6,}" required
                   placeholder="Repeat your password" autocomplete="off" validate/>
